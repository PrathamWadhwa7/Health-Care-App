...
tit1.markdown("<h1 style='text-align: center;'><u>Heart Attack & Breast Cancer Analyser</u> </h1>",unsafe_allow_html=True)
...
def plot_op(dataset_name):
    ...
    plt.title("Bar Graph for Sample Data")
    if dataset_name == "Heart Attack":
        col1.write(Y)
...
user_predict()  #Predict the status of user.ionTreeClassifier
